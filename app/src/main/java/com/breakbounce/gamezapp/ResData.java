...
public class ResData {
    ...
    private static String _privacy_policy_url;
    private static String _support_email_address;
    ...
    public static void init(Context context) {
        ...
        _privacy_policy_url = context.getResources().getString(R.string.privacy_policy_url);
        _support_email_address = context.getResources().getString(R.string.support_email_address);
    }
